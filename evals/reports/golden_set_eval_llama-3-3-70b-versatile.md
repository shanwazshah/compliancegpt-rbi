...
- Date: 2026-08-03
- Commit: `d87bcdfe0520`
- Generation model: `llama-3.3-70b-versatile` (classify: `llama-3.1-8b-instant`)
...
|---|---|---|
| Citation accuracy | 54.2% | 59 citations |
| Temporal correctness | 100.0% | 34 date-scoped rows |
| Refusal correctness | 100.0% | 3 out-of-scope rows |
